...
> - **Blog post**: [Automate data lineage on Amazon MWAA with OpenLineage](https://aws.amazon.com/blogs/big-data/automate-data-lineage-on-amazon-mwaa-with-openlineage/)
> - **Original repository**: [aws-samples/aws-mwaa-openlineage](https://github.com/aws-samples/aws-mwaa-openlineage) (Airflow 2.x)
> - **DR implementation**: [aws-samples/mwaa-disaster-recovery](https://github.com/aws-samples/mwaa-disaster-recovery) (Airflow 2.x)
>
