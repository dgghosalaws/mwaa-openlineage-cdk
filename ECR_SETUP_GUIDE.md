# ECR Setup Guide for Marquez HA

## Overview

This guide explains how to mirror Marquez Docker images to Amazon ECR to avoid Docker Hub rate limits.

## Why ECR?

Docker Hub has anonymous pull rate limits:
- **Anonymous users**: 100 pulls per 6 hours
- **Authenticated free users**: 200 pulls per 6 hours

When deploying HA with Auto Scaling, multiple instances pulling images can quickly hit these limits, causing deployment failures.
